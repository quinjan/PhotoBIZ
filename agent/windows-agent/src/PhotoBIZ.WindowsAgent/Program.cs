...
builder.Services.AddHttpClient<ILumaBoothConnectionTester, LumaBoothConnectionTester>();
...
builder.Services.AddSingleton<IAgentDiagnosticsSanitizer, AgentDiagnosticsSanitizer>();
builder.Services.AddSingleton<IAgentDiagnosticsExporter, AgentDiagnosticsExporter>();
...
builder.Services.AddSingleton<IBoothUiLaunchStateStore, FileBoothUiLaunchStateStore>();
