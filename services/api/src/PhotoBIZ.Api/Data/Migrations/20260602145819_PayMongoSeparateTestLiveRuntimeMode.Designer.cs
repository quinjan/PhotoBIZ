...
namespace PhotoBIZ.Api.Data.Migrations
{
    ...
    [Migration("20260602145819_PayMongoSeparateTestLiveRuntimeMode")]
    partial class PayMongoSeparateTestLiveRuntimeMode
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PhotoBIZ.Api.Data.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("CanApproveCash")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("can_approve_cash");

                    b.Property<bool>("CanCancelTransaction")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("can_cancel_transaction");

                    b.Property<bool>("CanReturnBoothToWelcome")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                        .HasColumnName("can_return_booth_to_welcome");
            ...
            modelBuilder.Entity("PhotoBIZ.Api.Data.Booth", b =>
                {
                    ...
                    b.Property<bool?>("AgentApiReachable")
                        .HasColumnType("boolean")
                        .HasColumnName("agent_api_reachable");

                    b.Property<bool?>("AgentChromeLaunched")
                        .HasColumnType("boolean")
                        .HasColumnName("agent_chrome_launched");
                    ...
                    b.Property<string>("AgentHealthStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasDefaultValue("UNKNOWN")
                        .HasColumnName("agent_health_status");

                    b.Property<bool?>("AgentKioskRunning")
                        .HasColumnType("boolean")
                        .HasColumnName("agent_kiosk_running");

                    b.Property<string>("AgentLumaBoothMode")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("agent_luma_booth_mode");

                    b.Property<bool?>("AgentLumaBoothReachable")
                        .HasColumnType("boolean")
                        .HasColumnName("agent_luma_booth_reachable");

                    b.Property<DateTimeOffset?>("AgentMetadataUpdatedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("agent_metadata_updated_at");

                    b.Property<string>("AgentRuntimeKind")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)")
                        .HasColumnName("agent_runtime_kind");

                    b.Property<bool?>("AgentTriggerListenerRunning")
                        .HasColumnType("boolean")
                        .HasColumnName("agent_trigger_listener_running");
            ...
            modelBuilder.Entity("PhotoBIZ.Api.Data.BoothAppearanceConfig", b =>
                {
                    ...
                    b.Property<string>("CompletionThankYouMessage")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("completion_thank_you_message");
            ...
            modelBuilder.Entity("PhotoBIZ.Api.Data.ClientPaymentProviderConfig", b =>
                {
                    ...
                    b.Property<bool>("RuntimeActive")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("runtime_active");
                    ...
                    b.HasIndex("ClientAccountId", "Provider", "IntegrationType", "PaymentMode")
                        .IsUnique()
            ...
            modelBuilder.Entity("PhotoBIZ.Api.Data.PaymentAttempt", b =>
                {
                    ...
                    b.Property<string>("TestPaymentUrl")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("test_payment_url");
                    ...
                    b.HasIndex("ClientPaymentProviderConfigId")
                        .HasDatabaseName("ix_payment_attempts_client_payment_provider_config_id");
            ...
            modelBuilder.Entity("PhotoBIZ.Api.Data.Transaction", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("TerminalNoticeAcknowledgedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("terminal_notice_acknowledged_at");
            ...
            modelBuilder.Entity("PhotoBIZ.Api.Data.PaymentAttempt", b =>
                {
                    b.HasOne("PhotoBIZ.Api.Data.ClientPaymentProviderConfig", "ClientPaymentProviderConfig")
                        ...
                        .HasForeignKey("ClientPaymentProviderConfigId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_payment_attempts_client_payment_provider_configs_client_pay~");
