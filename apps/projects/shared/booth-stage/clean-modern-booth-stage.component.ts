...
@Component({
  selector: 'photobiz-clean-modern-booth-stage',
  imports: [CommonModule],
  templateUrl: './clean-modern-booth-stage.component.html',
  styleUrl: './clean-modern-booth-stage.component.scss',
})
export class CleanModernBoothStageComponent {
